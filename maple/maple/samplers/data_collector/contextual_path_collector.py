...
from maple.envs.contextual import ContextualEnv
from maple.policies.base import Policy
from maple.samplers.data_collector import MdpPathCollector
from maple.samplers.rollout_functions import contextual_rollout
...
class ContextualPathCollector(MdpPathCollector):
    def __init__(
        ...
        **kwargs
        ...
        super().__init__(env, policy, max_num_epoch_paths_saved, render, render_kwargs, rollout_fn=rollout_fn, **kwargs)
