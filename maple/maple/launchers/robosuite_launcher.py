...
def experiment(variant):
    def make_env(mode):
        ...
        controller_config = load_part_controller_config(default_controller=env_variant["controller_type"])
    ...
    if action_dim_s == 0:
        ...
        policy = policy_class(
            obs_dim=obs_dim, action_dim_s=action_dim_s, action_dim_p=action_dim_p, hidden_sizes=[M, M], **policy_kwargs
        )
