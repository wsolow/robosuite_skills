...
class PAMDPPolicy(PyTorchModule, TorchStochasticPolicy):
    def __init__(
        ...
        self.policy = HierarchicalPolicy(task_policy, param_policy, policy1_obs_dim=obs_dim)
...
class CategoricalPolicy(Mlp, TorchStochasticPolicy):
    def __init__(self, hidden_sizes, obs_dim, action_dim, prefix="", init_w=1e-3, one_hot=False, **kwargs):
