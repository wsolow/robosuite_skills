...
from robosuite.controllers.skills.skill_controller import SkillController
...
class RobotEnv(MujocoEnv):
    ...
    def _pre_action(self, action, policy_step=False):
        ...
        assert len(action) == robot_dim, "environment got invalid action dimension -- expected {}, got {}".format(
