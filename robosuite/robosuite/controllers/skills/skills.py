...
class BaseSkill:
    def __init__(
        ...
        skill_type,
        ### common settings ###
        global_xyz_bounds=np.array([[-0.30, -0.30, 0.80], [0.15, 0.30, 0.90]]),
    ...
    def reset(self, params, config_update, info):
        ...
        self._aff_reward, self._aff_success = self._compute_aff_reward_and_success(info)
...
class AtomicSkill(BaseSkill):
    def __init__(self, skill_type, use_ori_params=True, use_gripper_params=True, **config):
        super().__init__(
            skill_type, use_ori_params=use_ori_params, use_gripper_params=use_gripper_params, max_ac_calls=1, **config
        )
...
class GripperSkill(BaseSkill):
    def __init__(self, skill_type, max_ac_calls=4, **config):
        super().__init__(skill_type, max_ac_calls=max_ac_calls, **config)
...
class ReachOSCSkill(BaseSkill):
    ...
    def _get_reach_pos(self, info):
        ...
        if self._config["use_delta"]:
            ...
            pos = self._get_unnormalized_pos(params[:3], self._config["global_xyz_bounds"])
...
class ReachSkill(BaseSkill):
    ...
    def __init__(self, skill_type, use_gripper_params=True, use_ori_params=False, max_ac_calls=15, **config):
        super().__init__(
            skill_type,
            use_gripper_params=use_gripper_params,
            use_ori_params=use_ori_params,
...
class GraspSkill(BaseSkill):
    ...
    def __init__(
        self, skill_type, use_ori_params=True, max_ac_calls=15, num_reach_steps=1, num_grasp_steps=1, **config
    ):
        super().__init__(
            skill_type,
            use_ori_params=use_ori_params,
...
class PushSkill(BaseSkill):
    ...
    def __init__(self, skill_type, max_ac_calls=20, use_ori_params=True, **config):
